    ...
    <>
      ...
      <section style={{ background: "#FAFAF7", padding: "56px 1.5rem 40px", textAlign: "center", borderBottom: "1px solid #E5E7EB" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 700, color: "#2D2D3A", margin: "0 0 1rem" }}>
            About <span style={{ color: "#6C5CE7" }}>AISIA Club</span>
          </h1>
      ...
      <section className="section-pad" style={{ background: "#FFFFFF" }}>
        <div className="container-article">
          ...
          <p style={{ color: "#6B7280", fontSize: "1.05rem", lineHeight: 1.8, borderLeft: "3px solid #6C5CE7", paddingLeft: "1.25rem", margin: "0 0 2rem" }}>
          ...
          <div style={{ background: "#F3F0FF", borderRadius: 12, padding: "1.25rem 1.5rem", border: "1px solid #E5E7EB" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 24, textAlign: "center" }}>
            {[
              ...
              <div key={s.label} className="card" style={{ padding: 24 }}>
                <div style={{ fontSize: "2rem", fontWeight: 700, color: "#6C5CE7" }}>{s.num}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
            {[
              ...
              <div key={r.num} className="card" style={{ padding: 24 }}>
                <div style={{ color: "#6C5CE7", fontSize: "1.75rem", fontWeight: 800, marginBottom: "0.75rem", opacity: 0.6 }}>{r.num}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 24 }}>
            {[
              ...
              <div key={w.title} className="card" style={{ padding: 24, textAlign: "center" }}>
                ...
                <h3 style={{ fontSize: "1.05rem", fontWeight: 700, color: "#6C5CE7", margin: "0 0 0.5rem" }}>{w.title}</h3>
