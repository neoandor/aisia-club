...
export default function Community() {
  return (
    <>
      ...
      {/* Activity strip */}
      <section style={{ background: "#F3F0FF", borderBottom: "1px solid #E5E7EB" }}>
      ...
      <section className="section-pad" style={{ background: "#FFFFFF" }}>
        <div className="container">
          <h2 style={{ textAlign: "center", fontSize: "1.5rem", fontWeight: 700, color: "#2D2D3A", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
            {[
              ...
              <div key={ch.name} className="card" style={{ padding: 24, textAlign: "center" }}>
                ...
                <h3 style={{ fontSize: "1.1rem", fontWeight: 700, color: "#2D2D3A", margin: "0 0 8px" }}>{ch.name}</h3>
                <p style={{ color: "#6B7280", fontSize: "0.9rem", lineHeight: 1.65, marginBottom: 20 }}>{ch.desc}</p>
                <a
                  href={ch.href}
                  style={{
      ...
      {/* Coming Soon */}
      <section style={{ background: "linear-gradient(135deg, #F3F0FF 0%, #FAFAF7 100%)", padding: "80px 1.5rem" }}>
